(function () {
	...
	function addonStart() {
		...
		Lampa.SettingsApi.addParam({
			...
			onChange: function (value) {
				if (value == '1') {
					itemON('https://frost1k.github.io/lppl/otziv.js', 'Отзывы', '@elenatv99', 'Feedback');
				}
				if (value == '2') {
					var pluginToRemoveUrl = "https://frost1k.github.io/lppl/otziv.js";
					deletePlugin(pluginToRemoveUrl);
				}
			},
			onRender: function (item) {
				$('.settings-param__name', item).css('color', 'f3d900'); hideInstall()
				var myResult = checkPlugin('https://frost1k.github.io/lppl/otziv.js')
				setTimeout(function () {
		...
		Lampa.SettingsApi.addParam({
			...
			onChange: function (value) {
				if (value == '1') {
					itemON('https://frost1k.github.io/lppl/rating.js', 'Рейтинг КиноПоиск и IMDB', '@t_anton', 'Rating');
				}
				if (value == '2') {
					var pluginToRemoveUrl = "https://frost1k.github.io/lppl/rating.js";
					deletePlugin(pluginToRemoveUrl);
				}
			},
			onRender: function (item) {
				$('.settings-param__name', item).css('color', 'f3d900'); hideInstall()
				var myResult = checkPlugin('https://frost1k.github.io/lppl/rating.js')
				setTimeout(function () {
		...
		Lampa.SettingsApi.addParam({
			...
			onChange: function (value) {
				if (value == '1') {
					itemON('https://frost1k.github.io/lppl/want.js', 'Старый Стиль Пунктов (Закладки, Нравится, Позже)', '@VitalikPVA', 'Want');
				}
				if (value == '2') {
					var pluginToRemoveUrl = "https://frost1k.github.io/lppl/want.js";
					deletePlugin(pluginToRemoveUrl);
				}
			},
			onRender: function (item) {
				$('.settings-param__name', item).css('color', 'f3d900'); hideInstall()
				var myResult = checkPlugin('https://frost1k.github.io/lppl/want.js')
				setTimeout(function () {
		...
		Lampa.SettingsApi.addParam({
			...
			onChange: function (value) {
				if (value == '1') {
					itemON('https://frost1k.github.io/lppl/reset_subs.js', 'Сброс Настроек Субтитров', '@t_anton', 'Sub_reset');
				}
				if (value == '2') {
					var pluginToRemoveUrl = "https://frost1k.github.io/lppl/reset_subs.js";
					deletePlugin(pluginToRemoveUrl);
				}
			},
			onRender: function (item) {
				$('.settings-param__name', item).css('color', 'f3d900'); hideInstall()
				var myResult = checkPlugin('https://frost1k.github.io/lppl/reset_subs.js')
				setTimeout(function () {
		...
		Lampa.SettingsApi.addParam({
			...
			onChange: function (value) {
				if (value == '1') {
					itemON('https://frost1k.github.io/lppl/e.js', 'Выход', '@tsynik', 'Exit_Menu');
				}
				if (value == '2') {
					var pluginToRemoveUrl = "https://frost1k.github.io/lppl/e.js";
					deletePlugin(pluginToRemoveUrl);
				}
			},
			onRender: function (item) {
				$('.settings-param__name', item).css('color', 'f3d900'); hideInstall();
				var myResult = checkPlugin('https://frost1k.github.io/lppl/e.js')
				setTimeout(function () {
		...
		Lampa.SettingsApi.addParam({
			...
			onChange: function (value) {
				if (value == '1') {
					itemON('https://frost1k.github.io/lppl/hotkeys.js', 'Горячие Кнопки', '@nnmd', 'Hot_Buttons');
				}
				if (value == '2') {
					var pluginToRemoveUrl = "https://frost1k.github.io/lppl/hotkeys.js";
					deletePlugin(pluginToRemoveUrl);
				}
			},
			onRender: function (item) {
				$('.settings-param__name', item).css('color', 'f3d900'); hideInstall();
				var myResult = checkPlugin('https://frost1k.github.io/lppl/hotkeys.js')
				setTimeout(function () {
		...
		Lampa.SettingsApi.addParam({
			...
			onChange: function (value) {
				if (value == '1') {
					itemON('https://frost1k.github.io/lppl/select_weapon.js', 'Тип Управления', '@nemiroff', 'Select_Weapon');
				}
				if (value == '2') {
					var pluginToRemoveUrl = "https://frost1k.github.io/lppl/select_weapon.js";
					deletePlugin(pluginToRemoveUrl);
				}
			},
			onRender: function (item) {
				$('.settings-param__name', item).css('color', 'f3d900'); hideInstall();
				var myResult = checkPlugin('https://frost1k.github.io/lppl/select_weapon.js')
				setTimeout(function () {
		...
		Lampa.SettingsApi.addParam({
			...
			onChange: function (value) {
				if (value == '1') {
					itemON('https://frost1k.github.io/lppl/not_mobile.js', 'Выключение Тача', '@t_anton', 'Touch_off');
				}
				if (value == '2') {
					var pluginToRemoveUrl = "https://frost1k.github.io/lppl/not_mobile.js";
					deletePlugin(pluginToRemoveUrl);
				}
			},
			onRender: function (item) {
				$('.settings-param__name', item).css('color', 'f3d900'); hideInstall();
				var myResult = checkPlugin('https://frost1k.github.io/lppl/not_mobile.js')
				setTimeout(function () {
		...
		Lampa.SettingsApi.addParam({
			...
			onChange: function (value) {
				if (value == '1') {
					itemON('https://frost1k.github.io/lppl/online_mod.js', 'Online Mod', '@t_anton', 'Online_Mod');
				}
				if (value == '2') {
					var pluginToRemoveUrl = "https://frost1k.github.io/lppl/online_mod.js";
					deletePlugin(pluginToRemoveUrl);
				}
			},
			onRender: function (item) {
				$('.settings-param__name', item).css('color', 'f3d900'); hideInstall();
				var myResult = checkPlugin('https://frost1k.github.io/lppl/online_mod.js')
				setTimeout(function () {
		...
		Lampa.SettingsApi.addParam({
			...
			onChange: function (value) {
				if (value == '1') {
					itemON('https://frost1k.github.io/lppl/addon_mod/jackett.js', 'Переключение Парсеров', '@AndreyURL54', 'Switch_Parser');
				}
				if (value == '2') {
					var pluginToRemoveUrl = "https://frost1k.github.io/lppl/addon_mod/jackett.js";
					deletePlugin(pluginToRemoveUrl);
				}
			},
			onRender: function (item) {
				$('.settings-param__name', item).css('color', 'f3d900'); hideInstall();
				var myResult = checkPlugin('https://frost1k.github.io/lppl/addon_mod/jackett.js')
				setTimeout(function () {
		...
		Lampa.SettingsApi.addParam({
			...
			onChange: function (value) {
				if (value == '1') {
					itemON('https://frost1k.github.io/lppl/addon_mod/diseltv.js', 'Дизель ТВ', '@AndreyURL54', 'Diesel');
				}
				if (value == '2') {
					var pluginToRemoveUrl = "https://frost1k.github.io/lppl/addon_mod/diseltv.js";
					deletePlugin(pluginToRemoveUrl);
				}
			},
			onRender: function (item) {
				$('.settings-param__name', item).css('color', 'f3d900'); hideInstall();
				var myResult = checkPlugin('https://frost1k.github.io/lppl/addon_mod/diseltv.js')
				setTimeout(function () {
